...
class DailySales(BaseModel):
    ...
    grower_id = db.Column(db.String(60), db.ForeignKey('farmers.id'), nullable=False)
    ...
    def __repr__(self):
        ...
        return (f"<DailySales(grower_id={self.grower_id}, factory={self.factory}, "
                f"transaction_id={self.transaction_id}, plucking_date={self.plucking_date}, "
                f"total_gross_weight={self.total_gross_weight}, total_tare_weight={self.total_tare_weight}, "
